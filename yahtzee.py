...
class YahtzeeHand:
    ...
    # Please use the area above to write any private helper methods 
    # that you would like.
    ...
    def three_of_a_kind_score(self):
        ...
        for value in rolled_values:
            ...
            # Cite: Lucas Barusek
            # Desc: The same idea of that it is a three-of-a-kind 
            # when there are four dices with the same value.
    ...
    def yahtzee_score(self):
        ...
        # Cite: Lucas Barusek
        # Desc: The idea of that if one value from the dices is
        # different from the rest, there is no Yahtzee.
        rolled_values = self._get_values()
        for value in rolled_values:
